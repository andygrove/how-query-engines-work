...
subprojects {
    ...
    dependencies {
        ...
        implementation("org.ballistacompute:datatypes:0.2.5-SNAPSHOT")
        implementation("org.ballistacompute:datasource:0.2.5-SNAPSHOT")
        implementation("org.ballistacompute:logical-plan:0.2.5-SNAPSHOT")
        implementation("org.ballistacompute:protobuf:0.2.5-SNAPSHOT")
        implementation("org.ballistacompute:executor:0.2.5-SNAPSHOT")
