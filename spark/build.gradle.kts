...
subprojects {
    ...
    dependencies {
        ...
        implementation("org.ballistacompute:datatypes:0.3.1-SNAPSHOT")
        implementation("org.ballistacompute:datasource:0.3.1-SNAPSHOT")
        implementation("org.ballistacompute:logical-plan:0.3.1-SNAPSHOT")
        implementation("org.ballistacompute:protobuf:0.3.1-SNAPSHOT")
        implementation("org.ballistacompute:executor:0.3.1-SNAPSHOT")
