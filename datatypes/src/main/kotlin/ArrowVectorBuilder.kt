    ...
    when (fieldVector) {
      ...
      is Float8Vector -> {
        if (value == null) {
          ...
          throw IllegalStateException("Cannot set Float8Vector with ${value.javaClass.name}")
        }
      }
      is DecimalVector -> {
        if (value == null) {
          ...
          fieldVector.set(i, decimal.setScale(fieldVector.scale, java.math.RoundingMode.HALF_UP))
        }
      }
      is Decimal256Vector -> {
        if (value == null) {
      ...
      is DateDayVector -> {
        if (value == null) {
          ...
          throw IllegalStateException("Cannot set DateDayVector with ${value.javaClass.name}")
        }
      }
      else -> throw IllegalStateException("Unsupported vector type: ${fieldVector.javaClass.name}")
    }
  }
