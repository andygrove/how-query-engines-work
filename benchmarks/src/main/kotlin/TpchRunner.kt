 ...
 *
 * Arguments: sql-file Path to SQL file containing the query data-dir Path to directory containing
 * TPC-H parquet files
 *
 * Expected parquet files in data-dir: customer.parquet, lineitem.parquet, nation.parquet,
 * orders.parquet, part.parquet, partsupp.parquet, region.parquet, supplier.parquet
 */
fun main(args: Array<String>) {
  if (args.size != 2) {
    ...
    System.err.println("  data-dir  Path to directory containing TPC-H parquet files")
    System.exit(1)
  }
  ...
  val tables =
      listOf("customer", "lineitem", "nation", "orders", "part", "partsupp", "region", "supplier")
  for (table in tables) {
