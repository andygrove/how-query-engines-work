...
class DateSubtractInterval(val dateExpr: LogicalExpr, val intervalExpr: LogicalExpr) : LogicalExpr {
  override fun toField(input: LogicalPlan): Field {
...
class DateAddInterval(val dateExpr: LogicalExpr, val intervalExpr: LogicalExpr) : LogicalExpr {
  override fun toField(input: LogicalPlan): Field {
...
abstract class BooleanBinaryExpr(name: String, op: String, l: LogicalExpr, r: LogicalExpr) :
...
abstract class MathExpr(name: String, op: String, l: LogicalExpr, r: LogicalExpr) :
    BinaryExpr(name, op, l, r) {
...
/** Scalar function */
class ScalarFunction(val name: String, val args: List<LogicalExpr>, val returnType: ArrowType) :
    LogicalExpr {
  override fun toField(input: LogicalPlan): Field {
