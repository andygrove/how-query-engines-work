...
/** Logical expression representing a literal date value. */
class LiteralDate(val value: java.time.LocalDate) : LogicalExpr {

  override fun toField(input: LogicalPlan): Field {
    return Field(value.toString(), ArrowTypes.DateDayType)
  }
...
fun lit(value: java.time.LocalDate) = LiteralDate(value)

/** Logical expression representing a literal interval (days) value. */
class LiteralIntervalDays(val days: Long) : LogicalExpr {

  override fun toField(input: LogicalPlan): Field {
    return Field("$days days", ArrowTypes.IntervalDayTimeType)
  }
...
/** Logical expression for subtracting an interval from a date. */
class DateSubtractInterval(
    val dateExpr: LogicalExpr,
    val intervalExpr: LogicalExpr
) : LogicalExpr {
  override fun toField(input: LogicalPlan): Field {
    return Field("date_subtract", ArrowTypes.DateDayType)
  }
...
/** Logical expression for adding an interval to a date. */
class DateAddInterval(
    val dateExpr: LogicalExpr,
    val intervalExpr: LogicalExpr
) : LogicalExpr {
  override fun toField(input: LogicalPlan): Field {
    return Field("date_add", ArrowTypes.DateDayType)
  }
...
/**
 * Convenience method to create a greater than expression using an infix
 * operator
 */
...
/**
 * Convenience method to create a greater than or equals expression using an
 * infix operator
 */
...
/**
 * Convenience method to create a less than or equals expression using an infix
 * operator
 */
...
/**
 * Convenience method to create a multiplication expression using an infix
 * operator
 */
...
/**
 * Convenience method to wrap the current expression in an alias using an infix
 * operator
 */
...
class ScalarFunction(
    val name: String,
    val args: List<LogicalExpr>,
    val returnType: ArrowType
) : LogicalExpr {
  override fun toField(input: LogicalPlan): Field {
...
class CountDistinct(input: LogicalExpr) :
    AggregateExpr("COUNT DISTINCT", input) {
