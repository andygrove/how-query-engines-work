...
class CastExpression(val expr: Expression, val dataType: ArrowType) :
    Expression {
            ...
            val castValue =
                when (vv) {
                  ...
                  is Number -> vv.toDouble()
                      ...
                      throw IllegalStateException(
                          "Cannot cast value to Double: $vv")
                }
            builder.set(it, castValue)
          }
        }
