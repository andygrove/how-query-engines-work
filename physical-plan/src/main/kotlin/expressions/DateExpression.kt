...
class DateSubtractIntervalExpression(val dateExpr: Expression, val intervalExpr: Expression) :
    Expression {
  ...
  override fun evaluate(input: RecordBatch): ColumnVector {
    ...
    val fieldVector = FieldVectorFactory.create(ArrowTypes.DateDayType, dateCol.size())
...
class DateAddIntervalExpression(val dateExpr: Expression, val intervalExpr: Expression) :
    Expression {
