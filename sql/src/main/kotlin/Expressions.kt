...
/** Binary expression */
data class SqlBinaryExpr(val l: SqlExpr, val op: String, val r: SqlExpr) :
    SqlExpr {
...
/** SQL literal date */
data class SqlDate(val value: String) : SqlExpr {
  override fun toString() = "DATE '$value'"
}

/** SQL literal interval */
data class SqlInterval(val value: String) : SqlExpr {
  override fun toString() = "INTERVAL '$value'"
}
